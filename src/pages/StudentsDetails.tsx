...
const StudentsDetails: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-blue-100 shadow-lg rounded-lg">
      <div className="mb-6">
        <button onClick={() => navigate(-1)} className="text-blue-600 hover:text-blue-800 font-semibold py-2 px-4 border border-blue-600 rounded-md">
          &larr; Back
        </button>
      </div>
      ...
      {student ? (
        <>
          <div className="text-center mb-8">
            ...
            <p className="font-bold text-2xl text-gray-500">Students Info</p>
          </div>
